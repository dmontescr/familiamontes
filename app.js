...
function initTreeVisualization() {
  ...
  setTimeout(() => {
    ...
    // Configuración de plantilla Opción B: Vertical / Ficha (220 x 130 px)
    FamilyTree.templates.montesTheme = Object.assign({}, FamilyTree.templates.john);
    FamilyTree.templates.montesTheme.size = [220, 130];
    
    // Tarjeta noble genérica
    FamilyTree.templates.montesTheme.node = `
      <clipPath id="cardClip{id}">
        <rect x="0" y="0" height="130" width="220" rx="14" ry="14"></rect>
      </clipPath>
      <rect x="0" y="0" height="130" width="220" fill="#ffffff" stroke-width="1.5" stroke="#d5cdbf" rx="14" ry="14" class="node-box" filter="drop-shadow(0px 4px 12px rgba(0,0,0,0.06))"></rect>
    ...
    FamilyTree.templates.montesTheme_male.node = `
      ...
      <rect x="0" y="0" height="130" width="220" fill="#ffffff" stroke-width="1.5" stroke="#cbd5e1" rx="14" ry="14" class="node-box" filter="drop-shadow(0px 4px 12px rgba(37,99,235,0.07))"></rect>
    ...
    FamilyTree.templates.montesTheme_female.node = `
      ...
      <rect x="0" y="0" height="130" width="220" fill="#ffffff" stroke-width="1.5" stroke="#fbcfe8" rx="14" ry="14" class="node-box" filter="drop-shadow(0px 4px 12px rgba(219,39,119,0.07))"></rect>
    ...
    FamilyTree.templates.montesTheme.field_0 = `
      <text style="font-size: 12px; font-weight: 700; font-family: 'Outfit', -apple-system, sans-serif;" fill="#1e293b" x="74" y="27">{val}</text>
    `;
    ...
    FamilyTree.templates.montesTheme.field_3 = `
      <text style="font-size: 12px; font-weight: 700; font-family: 'Outfit', -apple-system, sans-serif;" fill="#1e293b" x="74" y="41">{val}</text>
    `;
    ...
    FamilyTree.templates.montesTheme.field_4 = `
      <text style="font-size: 13px; font-weight: 700; font-family: 'Outfit', -apple-system, sans-serif;" fill="#1e293b" x="74" y="38">{val}</text>
    `;
    ...
    FamilyTree.templates.montesTheme.field_1 = `
      <text style="font-size: 11px; font-weight: 600; font-family: 'Outfit', -apple-system, sans-serif;" fill="#64748b" x="74" y="59">{val}</text>
    `;
    ...
    FamilyTree.templates.montesTheme.field_2 = `
      <g>
        <svg x="74" y="69" width="12" height="12" viewBox="0 0 24 24" fill="#e11d48" stroke="#e11d48" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path>
          <circle cx="12" cy="10" r="3" fill="#ffffff"></circle>
        </svg>
        <text style="font-size: 10.5px; font-weight: 500; font-family: 'Outfit', -apple-system, sans-serif;" fill="#64748b" x="89" y="80">{val}</text>
      </g>
    `;
    ...
    FamilyTree.templates.montesTheme.field_5 = `
      <text style="font-size: 10px; font-weight: 500; font-family: 'Outfit', -apple-system, sans-serif;" fill="#94a3b8" x="89" y="99">{val}</text>
    `;
