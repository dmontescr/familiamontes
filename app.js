...
function initTreeVisualization() {
  ...
  setTimeout(() => {
    ...
    // Fotografía circular centrada verticalmente con cursor de ampliación (cy = 68)
    FamilyTree.templates.montesTheme.img_0 = `
      <clipPath id="ulaImg{id}"><circle cx="40" cy="68" r="26"></circle></clipPath>
      <circle cx="40" cy="68" r="28" fill="none" stroke="#e2d9cd" stroke-width="2"></circle>
      <image preserveAspectRatio="xMidYMid slice" clip-path="url(#ulaImg{id})" xlink:href="{val}" x="14" y="42" width="52" height="52" style="cursor: zoom-in; pointer-events: all;"></image>
    `;
    ...
    FamilyTree.templates.montesTheme.field_0 = `
      <text style="font-size: 12.5px; font-weight: 700; font-family: 'Outfit', -apple-system, sans-serif;" fill="#1e293b" x="74" y="27">{val}</text>
    `;
    ...
    FamilyTree.templates.montesTheme.field_3 = `
      <text style="font-size: 12.5px; font-weight: 700; font-family: 'Outfit', -apple-system, sans-serif;" fill="#1e293b" x="74" y="43">{val}</text>
    `;
    ...
    FamilyTree.templates.montesTheme.field_4 = `
      <text style="font-size: 13px; font-weight: 700; font-family: 'Outfit', -apple-system, sans-serif;" fill="#1e293b" x="74" y="37">{val}</text>
    `;
    ...
    // Fechas vitales y edad (con mayor separación)
    FamilyTree.templates.montesTheme.field_1 = `
      <text style="font-size: 11px; font-weight: 600; font-family: 'Outfit', -apple-system, sans-serif;" fill="#64748b" x="74" y="67">{val}</text>
    `;
    ...
    FamilyTree.templates.montesTheme.field_2 = `
      <g>
        <svg x="74" y="79" width="12" height="12" viewBox="0 0 24 24" fill="#e11d48" stroke="#e11d48" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path>
          <circle cx="12" cy="10" r="3" fill="#ffffff"></circle>
        </svg>
        <text style="font-size: 10.5px; font-weight: 500; font-family: 'Outfit', -apple-system, sans-serif;" fill="#64748b" x="89" y="90">{val}</text>
      </g>
    `;
    ...
    FamilyTree.templates.montesTheme.field_5 = `
      <text style="font-size: 10px; font-weight: 500; font-family: 'Outfit', -apple-system, sans-serif;" fill="#94a3b8" x="89" y="110">{val}</text>
    `;
